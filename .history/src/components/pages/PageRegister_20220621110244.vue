<template>
  <div style="height: 600px">
    ...
    <div class="listbutton">
      <router-link to=listkink><b-button variant="primary" style=" width: 10%; padding: 10px;" @click="addTask">登録</b-button></router-link>
    </div>
...
export default {
  ...
  computed:{
...mapState(["Tasks", "newName",'newUrgency','newImpotance','newDay',"listlink"]),
  inputValue: {
      get() {
        return this.newName;
      },
