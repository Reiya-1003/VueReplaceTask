  ...
  <div style="height: 600px">
    <div class="listbox">
      <div class="listitem">
        ...
        ><span class="item"
          ><input type="text" class="textinput" v-model="inputValue"
        /></span>
      </div>
      ...
      <div class="listradioitem">
        ...
        <span class="item">
          <input
            ...
            name="importance"
            class="radioinput"
            v-model="inputImpotance"
          /><label for="imone">1</label>
          <input
            type="radio"
            id="imtwo"
            value="2"
          ...
          <input
            ...
            class="radioinput"
            v-model="inputImpotance"
          /><label for="imfive">5</label>
        </span>
      </div>
      <div class="listitem">
        <span class="itemtitle">期日</span
        ><span class="item"
          ><input type="date" class="dateinput" v-model="inputDay"
        /></span>
      </div>
    </div>
