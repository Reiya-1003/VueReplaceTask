<template>
  <div>
    <!-- グラフのエリア -->
    <div class="grapharea">
      <Chart :chartData="chartItems" :options="chartOptions" :height="height" v-if="!loding"/>
      <Chart :chartData="chartItems" :options="chartOptions" :height="height" v-else />
    </div>
    <div class="dayitem">
      ...
      /></span>
      <span><b-button v-on:click="kakunin">更新</b-button></span>
    </div>
  </div>
</template>
