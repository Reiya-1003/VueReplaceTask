<template>
  <div style="height: 600px">
    ...
    <div class="listbutton">
     <router-link to="/list"><b-button variant="primary" style=" width: 10%; padding: 10px;" @click="updateTask">登録</b-button></router-link> 
...
...mapGetters([
  ...
  inputDay:{
   ...
   methods: {
    ...mapMutations(["input","inputurgency", "inputimportance","inputday","updateTask",]),
    show() {
